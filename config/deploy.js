...
module.exports = function(deployTarget) {
  ...
  var redisKeyPrefix = 'chrislopresto-ember-islands';
  ...
  var ENV = {
    ...
    pipeline: {},
    slack: {
      webhookURL: process.env.CHRISLOPRESTO_EMBER_ISLANDS_SLACK_WEBHOOK
    },
    redis: {
      allowOverwrite: true,
  ...
  if (deployTarget === 'development') {
    ...
    ENV.redis.url = process.env.CHRISLOPRESTO_EMBER_ISLANDS_REDIS_URL;
  ...
  if (deployTarget === 'production') {
    ...
    ENV.s3.region = process.env.CHRISLOPRESTO_EMBER_ISLANDS_AWS_REGION;
    ENV.s3.accessKeyId = process.env.CHRISLOPRESTO_EMBER_ISLANDS_AWS_ACCESS_KEY_ID;
    ENV.s3.secretAccessKey = process.env.CHRISLOPRESTO_EMBER_ISLANDS_AWS_SECRET_ACCESS_KEY;
    ENV.s3.bucket = 'chrislopresto.com-assets';
  }
